...
<div class="container mt-4">
    <div class="row">
        <div class="col-8">
            <!-- Fórmula selecionada -->
            <div class="card bg-white rounded-top-15 shadow mb-3">
                    ...
                    <form method="post" action="{{URL::to('/Derivar')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <div class="input-group input-group-sm mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="valor1">Linha:</span>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="input-group input-group-sm mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="valor2">Linha:</span>
                                    </div>
                        ...
                        <div class="row justify-content-center mt-4">
                            <div class="col-4" >
                                <button type="submit" class="btn btn-block bg-gradient-success text-white"><i class="far fa-play-circle"></i>&nbsp;&nbsp;Aplicar</button>
                            </div>
                        </div>
                    </form>
                </div>
